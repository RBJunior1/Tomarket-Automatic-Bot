                ...
                if balance_response is not None:
                    ...
                    if daily_status_code == 400:
                        if daily['message'] == 'already_check':
                            ...
                            print(f"{Fore.GREEN+Style.BRIGHT}[ Daily ]: Checked in day : {day}  | {point} Point{Style.RESET_ALL}", flush=True)
                        else:
                            print(f"{Fore.RED+Style.BRIGHT}[ Daily ]: Failed {daily} {Style.RESET_ALL}", flush=True)
                    ...
                    if farming_status_code == 200:
                        ...
                        print(f"{Fore.GREEN+Style.BRIGHT}[ Farming ]: Started. Required in: {int(hours)} Hours {int(minutes)} minutes {Style.RESET_ALL}", flush=True)
                        if datetime.now() > end_time:
                                ...
                                if claim_status_code == 200:
                                    ...
                                    if farming_status_code == 200:
                                        ...
                                        hours, remainder = divmod(remaining_time.total_seconds(), 3600)
                                        minutes, _ = divmod(remainder, 60)
                                        print(f"{Fore.GREEN+Style.BRIGHT}[ Farming ]: Started. Claim in: {int(hours)} Hours {int(minutes)} minutes {Style.RESET_ALL}", flush=True)
                        ...
                        if farming['message'] == 'game already started':
                            ...
                            hours, remainder = divmod(remaining_time.total_seconds(), 3600)
                            minutes, _ = divmod(remainder, 60)
                            print(f"{Fore.CYAN+Style.BRIGHT}[ Farming ]: Already Started. Claim in: {int(hours)} Hours {int(minutes)} minutes {Style.RESET_ALL}", flush=True)
                    ...
                    while tiket > 0:
                        ...
                        if play_status != 200:
                            ...
                            if claim_status != 200:
                                print(f"{Fore.RED+Style.BRIGHT}[ Game ]: Unable to claim game points! {Style.RESET_ALL}", flush=True)
                            else:
                                print(f"{Fore.GREEN+Style.BRIGHT}[ Game ]: Success. Got {point} Poin {Style.RESET_ALL}                    ", flush=True)
...
if __name__ == "__main__":
    ...
    or_file_path = os.path.join(current_dir, "or.py")

    if os.path.exists(or_file_path):
        try:
            ...
            print(f"Error running or.py: {e}")
            sys.exit(1)  
    else:
        print("or.py not found. Script execution halted.")
        sys.exit(1)  
